...
public class User2BasicMapReduce extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		// set job
		Scan scan = new Scan();
		scan.setCaching(500);        // 每次获取多少条数据1 is the default in Scan, which will be bad for MapReduce jobs
		scan.setCacheBlocks(false);  // don't set to true for MR jobs
		// set other scan attrs

		// set input and set mapper，工具类代替以前的job.set操作
		...
		// set reducer and output，工具类代替以前的job.set操作
